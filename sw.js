const CACHE="ordo-v2-3";
const CORE=["/","/ordo.html","/manifest.webmanifest","/icon-192.png","/icon-512.png"];
...
self.addEventListener("push",event=>{
  ...
  event.waitUntil(self.registration.showNotification(data.title,{body:data.body,icon:"/icon-192.png",badge:"/icon-192.png",tag:data.tag||"ordo-alert",data:{url:data.url||"/"}}));
});
